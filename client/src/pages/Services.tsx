...
import FormContent from "../components/modals/modal-contents/FormContent";
import SuccessContent from "../components/modals/modal-contents/SuccessContent";

const Services = servicesWrapper(
  ({ handleOpenModal, isModalOpen, handleCloseModal, isCallModalOpen, handleCloseCallModal }) => (
    <>
      <Modal
        title="Պատվիրել զանգ"
        body={<FormContent />}
      ...
      <Container className=" lg:px-20 md:px10 px-5 gap-20 lg:pb-56 pb-32 lg:pt-32 pt-24">
        <div className=" w-full grid lg:grid-cols-2 lg:gap-10 gap-20 items-start lg:mb-20 lg:mt-0 mt-5">
          <div className=" flex items-start lg:justify-start justify-center flex-col gap-6">
            ...
            <Button onClick={handleOpenModal}>ՊԱՏՎԻՐԵԼ ԶԱՆԳ</Button>
          </div>
