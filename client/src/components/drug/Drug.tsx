...
function Drug({ drug }: Props) {
  ...
  return (
    <div className=" flex items-center flex-col gap-6 text-center p-6 rounded-xl bg-gray-1 relative overflow-hidden">
      <div
        className={` ${
      ...
      <div className=" w-fit aspect-video flex items-center justify-center">
